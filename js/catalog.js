...
class CatalogManager {
    ...
    async init() {
        ...
        this.renderProducts();
        this.renderWeeklyProducts(); // Новый метод для товаров недели
    ...
    // Новый метод для отображения товаров недели
    ...
    createWeeklyCard(product) {
        ...
        return `
            <div class="weekly-item">
                ...
                <button class="btn-weekly add-to-cart" data-id="${product.id}">
